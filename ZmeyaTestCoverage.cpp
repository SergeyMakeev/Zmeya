...
TEST(ZmeyaTestSuite, Coverage_P0_StringAppendManyReallocs)
{
    ...
    zm::BlobBuffer built = zm::detail::write_scope_with_initial_buffer_bytes<CovStringRoot>(
        [&model](zm::BlobWriter<CovStringRoot>& w)
        {
...
{
    zm::BlobBuffer golden = zm::detail::write_scope_with_initial_buffer_bytes<CovStringRoot>(
        [](zm::BlobWriter<CovStringRoot>& w)
        {
...
TEST(ZmeyaTestSuite, Coverage_P0_ArrayPushBackAcrossRealloc)
{
    ...
    zm::BlobBuffer built = zm::detail::write_scope_with_initial_buffer_bytes<CovIntArrayRoot>(
        [&model](zm::BlobWriter<CovIntArrayRoot>& w)
        {
            for (int32_t v : model)
            {
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovIntArrayRoot>(
...
TEST(ZmeyaTestSuite, Coverage_P0_MixedStringsAndArraysCompaction)
{
    ...
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<Root>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovDeepCopyRoot>(
...
TEST(ZmeyaTestSuite, Coverage_P1_HashSetStringIncrementalVsGolden)
{
    ...
    zm::BlobBuffer built = zm::detail::write_scope_with_initial_buffer_bytes<CovHashSetStrRoot>(
        [&model](zm::BlobWriter<CovHashSetStrRoot>& w)
        {
...
TEST(ZmeyaTestSuite, Coverage_P1_HashMapIntKeyIncrementalVsGolden)
{
    ...
    zm::BlobBuffer built = zm::detail::write_scope_with_initial_buffer_bytes<CovHashMapIntIntRoot>(
        [&model](zm::BlobWriter<CovHashMapIntIntRoot>& w)
        {
            for (const auto& kv : model)
            {
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovHashMapIntIntRoot>(
...
TEST(ZmeyaTestSuite, Coverage_P2_LongStringAssignRoundTrip)
{
    ...
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovStringRoot>(
...
{
    zm::BlobBuffer a = zm::detail::write_scope_with_initial_buffer_bytes<CovStringRoot>(
        [](zm::BlobWriter<CovStringRoot>& w)
        {
            w.root()->text = "identical_payload";
        }, 128, 4);

    zm::BlobBuffer b = zm::detail::write_scope_with_initial_buffer_bytes<CovStringRoot>(
        [](zm::BlobWriter<CovStringRoot>& w)
        {
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovStringCmpRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovArrayPtrRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovNullPointerRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovAllocAlignRoot>(
...
TEST(ZmeyaTestSuite, Coverage_P5_WriteBlobVectorMatchesFinalizeSize)
{
    ...
    zm::BlobBuffer viaVec = zm::detail::write_scope_with_initial_buffer_bytes<CovStringRoot>(
        [](zm::BlobWriter<CovStringRoot>& w)
        {
...
{
    zm::BlobBuffer bytes = zm::detail::write_scope_with_initial_buffer_bytes<CovHashMapIntIntRoot>(
        [](zm::BlobWriter<CovHashMapIntIntRoot>& w)
        {
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovIterEmptyRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovHashMapStrIntRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovAllKindsRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovVersionRoot>(
...
TEST(ZmeyaTestSuite, Coverage_P12_TwoWriteBlobPODDeterministicBytes)
{
    auto make = []()
    {
        return zm::detail::write_scope_with_initial_buffer_bytes<CovIntArrayRoot>(
            [](zm::BlobWriter<CovIntArrayRoot>& w)
            {
                for (int i = 0; i < 8; ++i)
                {
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovPairRoot>(
...
{
    zm::BlobBuffer blob = zm::detail::write_scope_with_initial_buffer_bytes<CovEnumRoot>(
